...
const BWPRadio:React.FC<BWPInputProps> = (props) => {

    const { className="", color="light-green", defaultChecked=false, onChange, ...rest } = props;
    ...
    return (<>
        <div className={`${className}`}>
            ...
            <input type="radio" ref={ref} className={`hidden`} defaultChecked {...rest} onChange={handleOnChange}/>
        </div>
    </>)
}

export default BWPRadio;