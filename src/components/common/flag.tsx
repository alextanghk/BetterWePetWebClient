...
const BWPFlag:React.FC<Props> = (props) => {
    ...
    return (<div className="relative">
        <div className={`w-max sm:h-12 h-10 relative bwp-bg-${color} flex sm:p-2 p-1 rounded-lg`}>
            <img src={icon} className="h-7 sm:h-8 z-10 sm:-mt-0.5 mt-0.5"/>
            <span className="sm:text-xl leading-8 text-base z-10 bwp-text-white mr-1.5">{ children }</span>
